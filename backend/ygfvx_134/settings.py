"""
Django settings for ygfvx_134 project.
...
WSGI_APPLICATION = 'ygfvx_134.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ygfvx_134 API",
    "DESCRIPTION": "API documentation for ygfvx_134 App",
    "VERSION": "v1",
}
